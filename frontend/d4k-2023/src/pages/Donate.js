                    ...
                    <div className="">
                        ...
                        <div className="flex justify-between mt-4">
                            <Button
                                text = "$5"
                                type = "button"
                                onClick = { donationAmount === 5 ? () => setDonationAmount(0) : () => donationHandler(5)}
                                buttonSelected = { donationAmount === 5 ? true : null }
                            />
                            <Button
                                text = "$10"
                                type = "button"
                                onClick = { donationAmount === 10 ? () => setDonationAmount(0) :() => donationHandler(10)}
                                buttonSelected = { donationAmount === 10 ? true : null }
                            />
                            <Button
                                text = "$20"
                                type = "button"
                                onClick = { donationAmount === 20 ? () => setDonationAmount(0) :() => donationHandler(20)}
                                buttonSelected = { donationAmount === 20 ? true : null }
                            />
                            <Button
                                text = "Other"
                                type = "button"
                                onClick = { donationAmount > 0 && donationAmount !== 5 && donationAmount !== 10 && donationAmount !== 20 ? () => setDonationAmount(0) : () => setSelectedOther(!selectedOther) }
