    ...
    return (
        <li className={ rankClass }>
            ...
            <div className="relative text-center pt-0 mt-0">
                <img src = { props.photoUrl ? props.photoUrl : image } alt = {`user rank ${props.rank}`} className={ imageClass + " border-5 shadow-xl drop-shadow-xl rounded-full border-white aspect-square object-cover " } />
