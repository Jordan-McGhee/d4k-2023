            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 rounded-lg">
                ...
                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    ...
                    <tr className="divide-x divide-gray-800">
                        ...
                        <th scope="col" className="px-6 py-3 text-center w-1/12">DRINKS</th>
                        <th scope="col" className="px-6 py-3 text-center w-1/12">TOTAL</th>
                        {/* <th>AMOUNT</th> */}
                        <th scope="col" className="px-6 py-3 text-center w-1/12">UNPAID</th>
                        <th scope="col" className="px-6 py-3 text-center w-1/12">DONATED</th>
